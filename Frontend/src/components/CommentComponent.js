        ...
        <div>
            <div className="containerComments">
                ...
                <div className="media">
                    <div className="media-left">
                        <img src="https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg" className="media-object" style={{width: "100px", border: "1px solid #c2c2c2"}}/>
                    </div>
                ...
                <div className="media">
                    <div className="media-left">
                        <img src="https://pg-biomedical.pglia.com/wp-content/uploads/2018/11/beautiful-woman-in-field-L5ARB9C-1.jpg" className="media-object" style={{width: "100px", border: "1px solid #c2c2c2"}}/>
                    </div>
                    <div className="media-body">
            ...
            <div className="container comment">
                ...
                <Form>
                    ...
                    <Button type="submit" variant="success" className="submitComment">SUBMIT COMMENT</Button>
                </Form>
            </div>
        </div>
        );
